...
// @author info
#define STRING_CONFIG_H_AUTHOR "(Tung, 3draion config)"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 3200, 100.470957 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 300,6, 15 }
...
#define MANUAL_FEEDRATE {50*60, 50*60, 4*60, 30} // Feedrates for manual moves along X, Y, Z, E from panel
// Homing speeds (mm/m)
...
#define Z_MAX_POS 204 //Change according to machine's dimension
