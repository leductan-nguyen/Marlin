 ...
 */
   ...
   */
  #define DETAILED_BUILD_VERSION SHORT_BUILD_VERSION " (3D Raion)"
   ...
   * version was tagged.
   */
  #define STRING_DISTRIBUTION_DATE "2018-04-11"
   ...
   * Marlin repository.
   */
  #define SOURCE_CODE_URL "https://github.com/BelovedTutu/Marlin"
   ...
   */
  #define WEBSITE_URL "http://3draion.com"
